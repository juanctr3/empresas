...
try {
    ...
    if (count($cols) >= 2) {
        echo "<span style='color:green'>[OK] Campos de base de datos presentes.</span><br>";
    } else {
        echo "<span style='color:red'>[ERROR] Faltan campos en la base de datos.</span><br>";
    }
} catch (Exception $e) {
...
echo "1. Ingresa a la sección de Configuración.<br>";
echo "2. Configura tu URL de Evolution API y Global API Key.<br>";
echo "3. Crea una instancia manualmente o verifica que el nombre asignado coincida.<br>";
echo "4. Usa el botón 'Probar Conexión' para validar.<br>";
?>
